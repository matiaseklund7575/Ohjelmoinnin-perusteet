...
average = (task1 + task2 + task3 + task4 + task5 + task6 + task7) / 7
print()
print("In total you spent", total, "minutes on programming.")
print("Average per task was", round(average, 2), "min and same rounded to the nearest integer", round(average), end="min.")
print("\nProgram ending.")